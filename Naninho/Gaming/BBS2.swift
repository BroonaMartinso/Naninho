...
class BouncyBallScene2: SKScene {
//, TouchableSpriteNodeDelegate, BallDelegate, LevelPresenting {
//    private var naninho: NaninhoProtocol!
...
//        if status == .intro {
//            for t in touches { naninho.handleTap(atPos: t.location(in: self), status: .inMenu) }
//        } else if status == .play {
//            for t in touches {
//                topBar.handleTap(atPos: t.location(in: topBar.representation))
//                naninho.handleTap(atPos: t.location(in: self), status: .inGame)
//            }
...
//
//        naninho.startGame(with: configuration) {
//            self.status = .play
//            self.topBar.appear()
...
//}
//
//extension BouncyBallScene2: PauseHandlerDelegate {
//    func pause() {
